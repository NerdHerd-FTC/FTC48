...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "V3")
@Disabled
public class _20231027_cindyTeleOpCodev2 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.dpad_down) {
                ...
                clawLeft.setPosition(clawLeftTarget);
